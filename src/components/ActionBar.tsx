...
const ActionBar = () => {
    ...
    return (
        <div className='w-2/5 h-screen border border-black rounded-3xl p-5'>
            <div className='grid grid-cols-1 gap-3 items-center flex px-5'>
                <div className='w-full flex justify-center text-center items-center mx-auto'>
                    ...
                    <input
                        className='w-3/5 border-solid border-2 border-blue-200 focus:border-green-200 focus:outline-none rounded-3xl p-2 text-center'
                ...
                <div className='w-full flex text-center items-center mx-auto'>
                    ...
                    <input
                        className='w-2/5 border-solid border-2 border-blue-200 rounded-3xl p-2 text-center'
                        placeholder='0'
                        value={courseID}
